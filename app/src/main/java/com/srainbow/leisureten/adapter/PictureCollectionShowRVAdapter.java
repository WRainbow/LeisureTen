...
public class PictureCollectionShowRVAdapter extends RecyclerView.Adapter<PictureCollectionShowRVAdapter.HDPictureShowHolder>
    ...
    public PictureCollectionShowRVAdapter(Context context, List<ImgWithAuthor> list){
    ...
    public void onBindViewHolder(HDPictureShowHolder holder, int position) {
        Glide.with(mContext).load("http:" + imgWithAuthorList.get(position).getImgUrl())
                ...
                .into(holder.mRectIv);
        holder.mTvAuther.setText(imgWithAuthorList.get(position).getImgAuthor());
        ...
        if(mItemInRvClickToDoListener != null){
            switch (v.getId()){
                ...
                case R.id.layout_collection_down_iv:
                    mItemInRvClickToDoListener.onItemWithParamViewClick(v, v.getTag(R.id.dataTag),
                            (ImageView)v.getTag(R.id.viewTag));
                    mItemInRvClickToDoListener.onItemWithParamPositionClick(v, v.getTag(R.id.dataTag),
